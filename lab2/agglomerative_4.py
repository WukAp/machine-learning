...
def show_clusters(df, clusters=5, linkage='average', name="===================="):
    ...
    shc.dendrogram(shc.linkage(norm_ag.to_numpy(), method=linkage))
    plt.show()
...
if __name__ == '__main__':
    ...
    show_clusters(third_df, name="======== lab2_noisymoons ========", clusters=6, linkage='ward')
    show_clusters(third_df, name="======== lab2_noisymoons ========", clusters=7, linkage='average')
